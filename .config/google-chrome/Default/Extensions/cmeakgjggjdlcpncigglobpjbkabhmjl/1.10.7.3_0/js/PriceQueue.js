...
var tf2Quality;
$J.getJSON('chrome-extension://' + SIHID + '/assets/json/tf2_quality.json', function (data) {
  tf2Quality = data;
});
...
var PriceQueue = {
    ...
    GenPriceDescription: function (rgItems) {
        ...
        if (rgItems.volume) {
            ddHtml += ' <span style="font-size: 0.9em; font-style: italic">(' + rgItems.volume + ' sold in 24h)</span>';
        }
