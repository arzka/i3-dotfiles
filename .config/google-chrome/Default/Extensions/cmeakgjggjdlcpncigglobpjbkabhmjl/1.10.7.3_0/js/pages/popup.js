...
$('#ck_nof, #ck_nof_friend, #ck_nof_comment, #ck_quickBuy, #ck_quickSell, #ck_instantSell, #ck_buySet, #ck_selectAll, #ck_offerdelay,' +
    ...
    ' #ck_currentPrice, #ck_historicalPrice, #ck_permalink, #ck_streamlink, #ck_floatValue, #ck_regionalPrice, #ck_allStores, #ck_hlWishlisted, #ck_hlOwned,' +
...
function reset_options() {
    storage.clear(function () {
        storage.set({
            ...
            owned: {
              show: true,
              color: highlightColors.owned
            },
            wishlist: {
              show: true,
              color: highlightColors.wishlist
            },
            tradableinfo: false
        }, function () {
            restore_options();
