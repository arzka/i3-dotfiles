...
g_rgCurrencyData = {
    ...
    "BRL": {"strCode": "BRL", "eCurrencyCode": 7, "strSymbol": "R$", "bSymbolIsPrefix": true, "bWholeUnitsOnly": false},
    "JPY": {
        "strCode": "JPY",
        "eCurrencyCode": 8,
        "strSymbol": "\u00a5",
    ...
    "IDR": {"strCode": "IDR", "eCurrencyCode": 10, "strSymbol": "Rp", "bSymbolIsPrefix": true, "bWholeUnitsOnly": true},
    "MYR": {
        "strCode": "MYR",
        "eCurrencyCode": 11,
        "strSymbol": "RM",
    ...
    "PHP": {"strCode": "PHP", "eCurrencyCode": 12, "strSymbol": "P", "bSymbolIsPrefix": true, "bWholeUnitsOnly": false},
    "SGD": {
        "strCode": "SGD",
        "eCurrencyCode": 13,
        "strSymbol": "S$",
    ...
    "ZAR": {"strCode": "ZAR", "eCurrencyCode": 28, "strSymbol": "R", "bSymbolIsPrefix": true, "bWholeUnitsOnly": false},
    "HKD": {
        "strCode": "HKD",
        "eCurrencyCode": 29,
        "strSymbol": "HK$",
...
const DELTA1MIN=6e4;
const MAIN_COUNTER_URL = (chrome.runtime.id === 'cbmjcfipbpicopmkbeefbcipckjilhaa'
  ? 'http://loc.steaminventoryhelper.org/api/sih/counter'
  : 'http://sih.gainskins.com/api/sih/counter');
const MAIN_API_URL = (chrome.runtime.id === 'cbmjcfipbpicopmkbeefbcipckjilhaa'
    ? 'http://loc.steaminventoryhelper.org/api/sih'
    : 'http://sih.gainskins.com/api/sih');
...
function abuseSSDescripCheck() {
    ...
    var $abuseDescriptionArea = $('abuseDescriptionArea');
    if (chkd_inap) {
...
function BindOnHashChange(fnCallback) {
    if ('onhashchange' in window) {
        Event.observe(window, 'hashchange', function (e) {
            fnCallback(this.location.hash);
        });
    } else {
        new LocationHashObserver(null, 0.1, function (el, hash) {
            fnCallback(hash);
        });
    }
}
